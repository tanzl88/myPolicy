...
//LOCALIZATION
app.factory('customLoader', ['$http', '$q', '$timeout', function ($http, $q, $timeout) {
    // return loaderFn
...
app.factory('currencyLoader', ['$http', '$q', '$timeout', function ($http,$q,$timeout) {
    // return loaderFn
    return function (options) {
        var deferred = $q.defer();
        var data = {
...
app.run(['$rootScope', '$ionicPlatform', '$state', '$cordovaNetwork', 'currencyService', '$ionicAnalytics', function ($rootScope,$ionicPlatform,$state,$cordovaNetwork,currencyService,$ionicAnalytics) {
