app.controller('linkedAccountCtrl', ['$scope', '$http', '$ionicHistory', '$translate', '$toast', '$timeout', 'loadingService', 'modalService', 'utilityService', 'loadDataDbService', 'credentialManager', 'clientListDbService', 'errorHandler', function($scope,$http,$ionicHistory,$translate,$toast,$timeout,loadingService,modalService,utilityService,
