app.controller('CreateClientAccountCtrl', ['$scope', '$http', '$ionicHistory', '$translate', '$toast', '$timeout', 'loadingService', 'modalService', 'loadDataDbService', 'credentialManager', 'clientListDbService', 'errorHandler', function($scope,$http,$ionicHistory,$translate,$toast,$timeout,loadingService,modalService,
