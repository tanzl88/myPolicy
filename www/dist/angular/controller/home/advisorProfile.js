app.controller('EditAdvisorProfileCtrl', ['$scope', '$q', '$http', '$timeout', '$toast', '$ionicHistory', '$toast', '$translate', '$cordovaFile', 'picNotesService', 'advisorDataDbService', 'loadingService', 'modalService', 'errorHandler', 'credentialManager', function($scope,$q,$http,$timeout,$toast,$ionicHistory,$toast,$translate,$cordovaFile,
