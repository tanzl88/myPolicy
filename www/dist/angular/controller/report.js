app.controller('ReportCtrl', ['$scope', '$translate', '$timeout', '$interval', '$state', '$translate', '$toast', '$ionicScrollDelegate', 'modalService', 'loadingService', 'policyDataService', 'barChartService', 'doughnutChartService', 'credentialManager', function($scope,$translate,$timeout,$interval,$state,$translate,$toast,$ionicScrollDelegate,modalService,
