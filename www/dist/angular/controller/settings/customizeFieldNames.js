app.controller('CustomizeFieldNamesCtrl', ['$scope', '$translate', '$http', '$timeout', '$ionicHistory', '$toast', 'loadingService', 'fieldNameService', 'errorHandler', function($scope,$translate,$http,$timeout,$ionicHistory,$toast,loadingService,fieldNameService,errorHandler) {
