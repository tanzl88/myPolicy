app.controller('ChangePasswordCtrl', ['$scope', '$rootScope', '$http', '$toast', '$ionicHistory', 'errorHandler', function($scope,$rootScope,$http,$toast,$ionicHistory,errorHandler) {
...
app.controller('ChangeEmailCtrl', ['$scope', '$rootScope', '$http', '$toast', '$ionicHistory', 'errorHandler', function($scope,$rootScope,$http,$toast,$ionicHistory,errorHandler) {
    $scope.reset = function(form) {
        if (form.$invalid) {
