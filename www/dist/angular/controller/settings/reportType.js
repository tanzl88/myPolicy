app.controller('ReportTypeCtrl', ['$scope', '$rootScope', '$state', '$toast', '$translate', 'reportTypeService', 'modalService', 'loadingService', function($scope,$rootScope,$state,$toast,$translate,reportTypeService,modalService,loadingService) {
...
app.controller('EditReportTypeCtrl', ['$scope', '$rootScope', '$ionicHistory', 'reportTypeService', 'modalService', 'utilityService', '$translate', '$toast', 'loadingService', function($scope,$rootScope,$ionicHistory,reportTypeService,modalService,utilityService,$translate,$toast,loadingService) {
    function hideEverything() {
        loadingService.hide();
