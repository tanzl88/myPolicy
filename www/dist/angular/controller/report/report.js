app.controller('ReportCtrl', ['$scope', '$translate', '$timeout', '$interval', '$state', '$translate', '$toast', '$ionicScrollDelegate', 'modalService', 'loadingService', 'personalDataDbService', 'policyDataService', 'policyDataDbService', 'barChartService', 'doughnutChartService', 'lineChartService', 'credentialManager', function($scope,$translate,$timeout,$interval,$state,$translate,$toast,$ionicScrollDelegate,modalService,
