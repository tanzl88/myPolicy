app.controller('ListCtrl', ['$rootScope', '$scope', '$state', '$filter', '$http', '$translate', '$timeout', '$toast', 'policyDataDbService', 'credentialManager', 'modalService', 'loadingService', 'errorHandler', function($rootScope,$scope,$state,$filter,$http,$translate,$timeout,$toast,
