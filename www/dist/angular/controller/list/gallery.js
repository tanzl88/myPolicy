app.controller('GalleryCtrl', ['$scope', '$rootScope', '$q', '$http', '$toast', '$translate', '$timeout', '$interval', '$ionicScrollDelegate', '$ionicHistory', '$cordovaCamera', '$cordovaFile', '$cordovaFileTransfer', 'picNotesService', 'loadingService', 'modalService', function($scope,$rootScope,$q,$http,$toast,$translate,$timeout,$interval,$ionicScrollDelegate,$ionicHistory,
