app.controller('GenerateReportCtrl', ['$scope', '$rootScope', '$q', '$state', '$translate', '$toast', '$timeout', '$cordovaFile', '$cordovaFileOpener2', '$cordovaEmailComposer', 'credentialManager', 'loadingService', 'modalService', 'utilityService', function($scope,$rootScope,$q,$state,$translate,$toast,$timeout,
