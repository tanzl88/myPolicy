app.controller('GenerateReportCtrl', ['$scope', '$rootScope', '$q', '$state', '$translate', '$toast', '$timeout', '$cordovaFile', '$cordovaFileOpener2', '$cordovaEmailComposer', '$cordovaKeyboard', 'credentialManager', 'personalDataDbService', 'reportTypeService', 'loadingService', 'modalService', 'utilityService', function($scope,$rootScope,$q,$state,$translate,$toast,$timeout,
