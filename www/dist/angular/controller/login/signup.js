app.controller('SignUpCtrl', ['$scope', '$http', '$ionicHistory', '$toast', 'modalService', function($scope,$http,$ionicHistory,$toast,modalService) {
...
app.controller('RetrieveAccountCtrl', ['$scope', '$http', '$toast', '$ionicHistory', 'modalService', function($scope,$http,$toast,$ionicHistory,modalService) {
    $scope.initVar = function() {
        //NO CACHE
    };
...
app.controller('RetrieveAccountNewCtrl', ['$rootScope', '$scope', '$http', '$toast', '$ionicHistory', 'modalService', function($rootScope,$scope,$http,$toast,$ionicHistory,modalService) {
    $scope.initVar = function() {
        //NO CACHE
    };
