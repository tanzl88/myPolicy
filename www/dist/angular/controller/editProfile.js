app.controller('EditProfileCtrl', ['$scope', '$translate', '$timeout', '$http', '$state', '$ionicHistory', '$ionicNavBarDelegate', '$ionicViewSwitcher', 'horoscopeService', 'ageIconService', 'personalDataDbService', 'loadingService', 'errorHandler', function($scope,$translate,$timeout,$http,
