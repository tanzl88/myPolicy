app.controller('CaseNotesCtrl', ['$scope', '$rootScope', '$http', '$state', '$translate', '$toast', 'modalService', 'loadingService', 'errorHandler', function($scope,$rootScope,$http,$state,$translate,$toast,modalService,loadingService,errorHandler) {
...
app.controller('AddCaseNotesCtrl', ['$scope', '$rootScope', '$http', '$state', '$ionicHistory', 'loadingService', 'errorHandler', function($scope,$rootScope,$http,$state,$ionicHistory,loadingService,errorHandler) {
    $scope.initVar = function() {
