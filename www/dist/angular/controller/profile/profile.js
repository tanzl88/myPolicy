app.controller('ProfileCtrl', ['$scope', '$state', '$http', '$translate', '$toast', '$timeout', '$ionicHistory', '$ionicScrollDelegate', '$cordovaEmailComposer', 'personalDataDbService', 'loadingService', 'credentialManager', 'errorHandler', function($scope,$state,$http,$translate,$toast,$timeout,$ionicHistory,$ionicScrollDelegate,$cordovaEmailComposer,
