app.controller('NotificationCtrl', ['$scope', '$toast', '$http', 'notificationDbService', 'advisorDataDbService', 'loadingService', 'errorHandler', function($scope,$toast,$http,notificationDbService,advisorDataDbService,loadingService,errorHandler) {
