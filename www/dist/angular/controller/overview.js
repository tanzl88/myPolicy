app.controller('OverviewCtrl', ['$scope', '$translate', '$timeout', '$interval', '$toast', '$ionicScrollDelegate', 'credentialManager', 'policyDataService', 'policyDataDbService', 'barChartService', 'lineChartService', function($scope,$translate,$timeout,$interval,$toast,$ionicScrollDelegate,credentialManager,
