angular.module('$countdownTimePicker', []).directive('countdownTimePicker', function () {
    return {
        ...
        require: [],
        template: '',
        controller: ['$scope', '$element', '$attrs', '$ionicModal', '$timeout', '$parse', '$state', '$translate', '$toast', 'findParentService', 'reminderService', 'utilityService', function ($scope, $element, $attrs, $ionicModal, $timeout, $parse, $state, $translate, $toast, findParentService, reminderService, utilityService) {
