angular.module('$suggestAmtEditor', []).directive('suggestAmtEditor', function () {
    return {
        ...
        controller: ['$scope', '$element', '$attrs', '$ionicModal', '$timeout', '$parse', '$state', '$translate', 'findParentService', function ($scope, $element, $attrs, $ionicModal, $timeout, $parse, $state, $translate, findParentService) {
