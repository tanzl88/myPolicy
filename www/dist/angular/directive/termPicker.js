angular.module('$termPicker', []).directive('termPicker', function () {
    return {
        ...
        controller: ['$scope', '$element', '$attrs', '$ionicModal', '$timeout', '$interval', '$parse', '$state', '$translate', 'findParentService', '$ionicSlideBoxDelegate', 'utilityService', function ($scope, $element, $attrs, $ionicModal, $timeout, $interval, $parse, $state, $translate, findParentService, $ionicSlideBoxDelegate, utilityService) {
