app.service('localNotificationService', ['$rootScope', '$q', '$state', '$ionicHistory', '$cordovaLocalNotification', '$translate', function ($rootScope, $q, $state, $ionicHistory, $cordovaLocalNotification, $translate) {
    var check_id_g = [];
