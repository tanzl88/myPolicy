app.service('reminderService', ['$rootScope', '$q', '$http', 'localNotificationService', 'clientListDbService', '$toast', 'loadingService', 'errorHandler', function($rootScope,$q,$http,localNotificationService,clientListDbService,$toast,loadingService,errorHandler) {
    var reminders = [];
