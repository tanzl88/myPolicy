app.service('pushNotificationService', ['$rootScope', '$http', '$cordovaDevice', '$cordovaPushV5', 'notificationDbService', '$toast', '$state', function ($rootScope,$http,$cordovaDevice,$cordovaPushV5,notificationDbService,$toast,$state) {
