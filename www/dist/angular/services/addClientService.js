app.service('addClientService', ['$q', '$http', '$toast', '$timeout', 'loadDataDbService', 'clientListDbService', 'credentialManager', 'loadingService', 'errorHandler', function($q,$http,$toast,$timeout,loadDataDbService,clientListDbService,credentialManager,loadingService,errorHandler) {
