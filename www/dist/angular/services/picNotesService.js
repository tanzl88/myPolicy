app.service('picNotesService', ['$q', '$http', '$toast', '$cordovaFile', '$cordovaFileTransfer', 'credentialManager', 'advisorDataDbService', 'personalDataDbService', 'loadingService', 'errorHandler', function($q,$http,$toast,$cordovaFile,$cordovaFileTransfer,credentialManager,advisorDataDbService,personalDataDbService,loadingService,errorHandler) {
