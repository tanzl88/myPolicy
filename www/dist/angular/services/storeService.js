app.service('storeService', ['$http', '$q', '$ionicHistory', 'advisorDataDbService', 'credentialManager', 'loadingService', 'errorHandler', function($http,$q,$ionicHistory,advisorDataDbService,credentialManager,loadingService,errorHandler) {
