...
function($q, $ionicCoreSettings, $timeout, $http, persistentStorage, $ionicApp) {
  ...
  return {
    ...
    _op: function(key, value, type) {
      ...
      var req = {
        method: 'POST',
        url: $ionicApp.getApiUrl() + '/api/v1/app/' + appId + '/users/' + type,
    ...
    identify: function(userData) {
      ...
      var req = {
        method: 'POST',
        url: $ionicApp.getApiUrl() + '/api/v1/app/' + appId + '/users/identify',
        transformRequest : function(data) {
          return JSON.stringify(data);
        },
        headers: {
...
.factory('$ionicCoreSettings', function() {
  var settings = {"app_id":"466843af","api_key":"499afdccf75ee8841660b0b6fff2d8823738a1a8b0223406","dev_push":false,"gcm_key":"798861488666"};
  return {
