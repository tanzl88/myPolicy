app.controller('AdvisorDashboardCtrl', function($rootScope,$scope,$timeout,findParentService) {
...
app.controller('ClientDashboardCtrl', function($rootScope,$scope,$state,$timeout,$interval,$translate,$filter,$ionicScrollDelegate,credentialManager,
