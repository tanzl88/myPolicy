app.controller('ReminderCtrl', function($scope,$translate,$timeout,$http,$toast,modalService,reminderService,clientListDbService,localNotificationService,loadingService,credentialManager) {
