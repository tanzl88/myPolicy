...
app.controller('ReportTabsCtrl', function($scope,$state,$timeout,$ionicScrollDelegate,credentialManager) {
...
app.controller('ClientsTabsCtrl', function($scope,$state,$timeout,$ionicViewSwitcher,$ionicScrollDelegate,$ionicHistory) {
    $scope.goTo = function(state) {
