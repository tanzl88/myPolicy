app.controller('SuggestAmtInputCtrl', function($scope,$state,$http,$translate,$toast,$timeout,$ionicHistory,$ionicScrollDelegate,
    ...
    $scope.submit = function() {
        ...
        var input = {
            ...
            treatmentCost           : parseInt($scope.personal.treatmentCost),
